...
<form action="/data-training-save" method="POST" class="forms-sample" enctype="multipart/form-data">
    <?= csrf_field(); ?>
    <div class="card">
        <div class="card-body">
            <h4 class="card-title">Tambah Data Trainning</h4>
            <p class="card-description">
                Masukkan data trainning baru!
            </p>
            <div class="row">
                <div class="col-md-6">
                ...
                <div class="col-md-6">
                    ...
                    <button type="submit" class="btn btn-primary me-2 mt-4">Tambah Data</button>
                    <a class="btn btn-light mt-4" href="data-training">Cancel</a>
                </div>
            </div>
        </div>
    </div>
